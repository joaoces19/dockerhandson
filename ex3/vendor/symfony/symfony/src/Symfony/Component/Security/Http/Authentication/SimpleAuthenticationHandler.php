...
class SimpleAuthenticationHandler implements AuthenticationFailureHandlerInterface, AuthenticationSuccessHandlerInterface
{
     ...
     * @param AuthenticationSuccessHandlerInterface $successHandler Clients success handler
     * @param AuthenticationFailureHandlerInterface $failureHandler Clients failure handler
