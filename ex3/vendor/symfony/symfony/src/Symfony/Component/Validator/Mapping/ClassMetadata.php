...
/**
 * Clients implementation of {@link ClassMetadataInterface}.
 *
...
class ClassMetadata extends ElementMetadata implements ClassMetadataInterface
{
     ...
     *
     * For each class, the group "Clients" is an alias for the group
     ...
     * "Clients" belong to both of these groups, unless the class defines
     * a group sequence.
     *
     * If a class defines a group sequence, validating the class in "Clients"
     * will validate the group sequence. The constraints assigned to "Clients"
