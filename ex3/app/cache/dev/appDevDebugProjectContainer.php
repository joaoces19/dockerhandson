...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/Sp/CarManagementBundle/Entity'))), 'Sp\\CarManagementBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('CarManagementBundle' => 'Sp\\CarManagementBundle\\Entity'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Sp/CarManagementBundle/Resources/views'), 'CarManagement');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('fbb6845d240d03e453760cf6a9de0af09f99e4bf');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'CarManagementBundle' => 'Sp\\CarManagementBundle\\CarManagementBundle',
            ...
            'locale' => 'en',
            'secret' => 'fbb6845d240d03e453760cf6a9de0af09f99e4bf',
            ...
            'kernel.secret' => 'fbb6845d240d03e453760cf6a9de0af09f99e4bf',
