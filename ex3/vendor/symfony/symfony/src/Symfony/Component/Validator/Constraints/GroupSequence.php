 ...
 * checks fail.
 *
 * When adding metadata to a class, you can override the "Clients" group of
 ...
 *     }
 *
 * Whenever you validate that object in the "Clients" group, the group sequence
 * will be validated:
 *
 *     $validator->validate($address);
 *
 * If you want to execute the constraints of the "Clients" group for a class
...
class GroupSequence implements \ArrayAccess, \IteratorAggregate, \Countable
{
     ...
     * "Clients" group. When validating that class in the "Clients" group, the
     * group sequence is used instead, but still the "Clients" group should be
